//Напиши клас StarTrack. Оголоси у цього класу два приватні поля типу Point з іменами start та finish. Напиши сеттери та геттери для цих полів.
//
//        Реалізуй методи equals() та hashCode() для класу StarTrack. Два об'єкти StarTrack вважаються рівні, якщо у них рівні точки start та finish.
